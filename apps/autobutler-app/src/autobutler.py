...
# Configuration
HA_URL = os.getenv("HA_URL", "http://homeassistant.local:8123") # Your Home Assistant URL
...
def usage():
    print("Usage: python autobutler.py", file=sys.stderr)
...
def main() -> int:
    ...
    while is_running:
        ...
        try:
            ...
            print("Invalid format. Use 'topic: question' (e.g., 'fridge: What’s in the fridge?')", file=sys.stderr)
